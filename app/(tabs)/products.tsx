        ...
        <View style={styles.cardInfo}>
          ...
          <View style={styles.cardFooter}>
            <View style={styles.cardFooterLeft}>
              {item?.print_label && (
                <View
                  style={[styles.labelBadge, { backgroundColor: "#F59E0B20" }]}
                >
                  <Ionicons name="pricetag-outline" size={14} color="#F59E0B" />
                  <Text style={[styles.labelBadgeText, { color: "#F59E0B" }]}>
                    Label needed
                  </Text>
                </View>
              )}
            ...
            <View style={styles.qtyBadge}>
              <Text style={styles.qtyText}>
                {item.virtual_available ?? item.qty_available} units
              </Text>
            </View>
          </View>
        </View>
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      {error && (
        ...
        >
          <Text
            style={[styles.errorText, { color: colors.danger || "#EF4444" }]}
          >
            {error}
          </Text>
        </View>
